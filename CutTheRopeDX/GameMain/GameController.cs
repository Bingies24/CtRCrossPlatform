...
namespace CutTheRopeDX.GameMain
{
    ...
    internal sealed class GameController : ViewController, IButtonDelegation, IGameSceneDelegate
    {
        ...
        public void LevelWon()
        {
            ...
            Game1.RPC.SetLevelPresence(ctrRoot.GetPack(), ctrRoot.GetLevel(), gameScene.starsCollected, gameScene.starCount, true, gameScene.levelName, gameScene.score, (int)gameScene.time);
